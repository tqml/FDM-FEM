...
%	\end{equation}
	...
	\begin{equation}
	\frac{1}{rh} \mathbf{A} \mathbf{u} + \frac{1}{h^2}\mathbf{B}  \mathbf{u} = \mathbf{f}
	\end{equation}
	...
	Die Methode der finiten Differenzen erlaubt eine zuverlässige Berechnung einer einfachen Differentialgleichung. Der relative Fehler in unserem Beispiel ist zum Teil sehr hoch und nimmt mit zunehmender Entfernung von den Randwerten zu.
	...
	\end{tabular}
	\caption{Ergebnisse für 10000 Stützstellen im Intervall $r=[1,5]$}
	\end{figure}
	...
	\begin{tabular}{|c|c|c|c|}
		\hline 
		&  Analytisch & Numerisch & Fehler [\%] \\ 
		\hline 
		$u_2$ & 43.0677 & 62.5000 & 45.1205 \\ 
		\hline 
		$u_3$ & 68.2606 & 83.3333 & 22.0811 \\ 
		\hline 
		$u_4$ & 86.1353 & 93.75004 & 8.8404 \\ 
		\hline 
	\end{tabular} 
